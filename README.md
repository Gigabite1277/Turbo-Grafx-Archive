...
## Project Goals
  ...
  * To build a web application that informs the users of Turbo Grafx (Europe 
    UK version) console from the late 1980s and it's cousins from Japan and North America.  
  * To list helpful information and answer questions the users have regarding regional compatibility issues etc.
  * Advise users on what games are available for this console.
...
#### User Story - One : Couldn't afford the Turbo Grafx when I was young
 ...
 User was able to go the Games and Gadgets section to find info . 
  Verified in Readmedocs folder> Console Compatibilty.png
---
...
#### User Story - Three: User not sure if his console can play certain games
 ...
 Acceptence Criteria Met: 
 User was able to go the Games and Gadgets section to find info . 
  Verified in Readmedocs folder> Game Information.png
...
#### User Story - Four: User wants to watch Turbo Grafx content for nostalgia.\
  ...
  * Acceptence Criteria Met: 
  User was able to go the Media Gallery and view videos of nostalgic content. 
  Verified in Readmedocs folder> Media Gallery.png
...
[The Turbo Grafx Archive Wireframes] (readmedocs/Wireframe Final.png))readmedocs/Wireframe Final.png
...
Please see the readmedocs folder for where there are 5 validation.png's for each page and the css file. 
---


## Credits
Wiki Pedia.com for "some" of PC Engine information.
